...
state_t load_state( const std::string &file_path,
    ...
    void save_state(const std::string &file_path, const size_t k, const state_t &current_state, const int * curr_cnt_number, const std::vector<double> &contact_regular, const double * result_by_week, const double lv, const double Accept_rate);
