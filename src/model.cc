...
void one_year_SEIR_with_vaccination(double * result, const std::vector<double> &Npop, double * seeding_infectious, const double tlatent, const double tinfectious, const double *s_profile, const std::vector<double> &contact_regular, double q, double *vaccination_calendar, double *vaccine_efficacy)
{
...
void save_scenarii( FILE *Scen1FS, FILE *Scen2FS, const std::vector<double> &pop_vec,  double *prop_init_inf, const state_t &state, const std::vector<double> &contact_mat, int n_scenarii, double **vaccine_cal, double **vaccine_efficacy_year, std::string path, int * First_write ) 
