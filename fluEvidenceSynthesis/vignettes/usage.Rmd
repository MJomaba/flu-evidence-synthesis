...
TODO: Say something about the general approach
...
build.llikelihood <- function()
{
  ...
  llikelihood.f <- function( pars )
  {
    ...
    # Run simulation
    # TODO Now: infection.model should take susceptibality and transmission and delay pars
...
# Run adaptive.mcmc
adaptive.mcmc( llprior, build.llikelihood,
               1000, c(0.01188150,0.01831852,0.05434378,1.049317e-05,0.1657944,
