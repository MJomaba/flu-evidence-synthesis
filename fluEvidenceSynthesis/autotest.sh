...
inotify-hookable -t 1000 -i '*.o' -i '\..*' -w data -w src -w tests -f DESCRIPTION -w R -c "R -e 'Rcpp::compileAttributes(\".\",verbose=TRUE)' && R CMD check ../fluEvidenceSynthesis; sleep 10"
